...
//Kinda nasy and duplicated with the map service but necessary evil for now to send the map data to the client
//and also not have to load them up every time a game is loaded
...
export default class Game
{
  ...
  static [fromSQL](resp)
  {
    ...
    g.name = resp.name;
    g.map = resp.map;
    g.mapData = mapRequires[resp.map] || null,
