...
export default class SockHarness
{
  ...
  /**
   * Manually bind a client to the RPC calls. This is automatically done for real ws clients when they connect
   * but for mock clients, i.e. AI, this will have to be done manually
   */
  bindClient(client)
  {
    this._server.bindClient(client);
  }
