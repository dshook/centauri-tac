...
{
    [Singleton] public class AuthMatchmakerSignal : Signal<PlayerModel, SocketKey> { }
    [Singleton] public class MatchmakerLoggedInSignal : Signal<LoginStatusModel, SocketKey> { }
