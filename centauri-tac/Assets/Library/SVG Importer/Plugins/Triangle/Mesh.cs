...
namespace SVGImporter.TriangleNet
{
    using System;
    using System.Collections.Generic;
    using System.Linq;
    using SVGImporter.TriangleNet.Data;
    using SVGImporter.TriangleNet.Log;
    using SVGImporter.TriangleNet.IO;
    using SVGImporter.TriangleNet.Algorithm;
    using SVGImporter.TriangleNet.Smoothing;
    using SVGImporter.TriangleNet.Geometry;
    using SVGImporter.TriangleNet.Tools;
