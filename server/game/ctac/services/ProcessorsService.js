...
import CardBuffProcessor from '../processors/CardBuffProcessor.js';
import PieceAuraProcessor from '../processors/PieceAuraProcessor.js';
import CardAuraProcessor from '../processors/CardAuraProcessor.js';
...
export default class TurnService
{
  constructor(app, queue)
  {
    ...
    queue.addProcessor(CardBuffProcessor);
    queue.addProcessor(PieceAuraProcessor);
    queue.addProcessor(CardAuraProcessor);
